...
Rhythm::FeatureSet Rhythm::getRemainingFeatures() {
  ...
  float firstShift = (int) roundf(60.f / max_bpm * m_sampleRate / m_stepSize);
  float lastShift = (int) roundf(60.f / min_bpm * m_sampleRate / m_stepSize);
